...
class HoverboardOmniDriver(Node):
    ...
    def _init_hoverboards(self):
        try:
            ...
            # Hardware mode - find device by vendor:product ID
    ...
    def _send_hoverboard_command(self, port, left_speed, right_speed):
        ...
        try:
            ...
            if simulation_mode:
                ...
                self.get_logger().info(f"SIMULATION: Sending command - Left: {left_speed}, Right: {right_speed}")
                return
            ...
            try:
                ...
                if simulation_mode:
                    ...
                    with self.lock:
                        ...
                        self.get_logger().info(f"SIMULATION: Front feedback - left: {fl}, right: {fr}")
                else:
    ...
    def destroy_node(self):
        ...
        # Only close port if it exists (not in simulation mode)
